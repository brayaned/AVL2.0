...
public class ArbolExpresionGrafico extends JPanel 
{
     ...
     * dibujar.
     */
    public ArbolExpresionGrafico(AVL miArbol) 
    {
    ...
    private void calcularPosiciones() 
    {
         posicionNodos.clear();
         subtreeSizes.clear();
         Nodo root = this.miArbol.raizArbol();
         if (root != null) 
         {
    ...
    private void dibujarArbol(Graphics2D g, Nodo n, int puntox, int puntoy, int yoffs) 
    {
     ...
     g.draw(r);
     g.drawString(n.getInfo()+"||"+n.getBal(), r.x + 3, r.y + yoffs);
   ...
   public void paint(Graphics g) 
   {
         ...
         dibujarArbol(g2d, this.miArbol.raizArbol(), Integer.MAX_VALUE, Integer.MAX_VALUE, 
